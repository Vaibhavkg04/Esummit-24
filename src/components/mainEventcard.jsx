...
const MainEventCard = ({ title, tagline, image }) => {
	...
	return (
		<>
			<div className=" border-[5px] border-sky-400 h-[220px] w-[130px] lg:w-[220px] lg:h-[290px] mr-4 ml-4 bg-white p-[20x] rounded-[10px] hover:scale-105 duration-300 relative">
