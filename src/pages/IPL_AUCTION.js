            ...
            <div>
                <section className="bg-red   min-h-screen  w-[100%] bg-cover py-5 ">
                    <div
                        ...
                        <form action='https://script.google.com/macros/s/AKfycbyrWeIwfpbucAIHN1e9andWmxKVx5qKGYtngLxNvrSt1THwfNSdIuXDvjSyAH_wUehu/exec' id='IPL_AUCTION' method='POST' className="space-y-8 text-white bg-none [  ]">
                            <div>
        ...
        <>
            ...
            >
                <div className="flex justify-center items-center pt-[100px]">
                    <h1 className="text-sky-400 font-bold lg:text-5xl text-3xl font-Orbitron">IPL AUCTION</h1>
                </div>
