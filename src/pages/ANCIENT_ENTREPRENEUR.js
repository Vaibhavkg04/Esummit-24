            ...
            <div>
                <section className="bg-red   min-h-screen  w-[100%] bg-cover py-5 ">
                    <div
                        ...
                        <form action='https://script.google.com/macros/s/AKfycbxm-SISbBq1T0zh9CTU1Mbejt4jD6I2H5ph2eYK0rQW8gse5nBPf6UhmXvPPS5MDG52/exec' id='ANCIENT_ENTREPRENEUR' method='POST' className="space-y-8 text-white bg-none [  ]">
                            <div>
        ...
        <>
            ...
            >
                <div className="flex justify-center items-center pt-[100px]">
                    <h1 className="text-sky-400 font-bold lg:text-5xl text-3xl font-Orbitron">ANCIENT ENTREPRENEUR</h1>
                </div>
