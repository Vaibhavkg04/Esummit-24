            ...
            <div>
                <section className="bg-red   min-h-screen  w-[100%] bg-cover py-5 ">
                    <div
                        ...
                        <form action='https://script.google.com/macros/s/AKfycbw20NQareEVUuVj3TQu9HDHnjer7nc5dq7WDbIboAFh_U7978TFwCOvbLRpPKe7i0_6Rw/exec' id='BIT_THON' method='POST' className="space-y-8 text-white bg-none [  ]">
                            <div>
        ...
        <>
            ...
            >
                <div className="flex justify-center items-center pt-[100px]">
                    <h1 className="text-sky-400 font-bold lg:text-5xl text-3xl font-Orbitron">BIT THON</h1>
                </div>
