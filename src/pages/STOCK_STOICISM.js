            ...
            <div>
                <section className="bg-red   min-h-screen  w-[100%] bg-cover py-5 ">
                    <div
                        ...
                        <form action='https://script.google.com/macros/s/AKfycbxzpZi_xhmdxeHoWwZZDzq78-rbKj2hV59Bk2WjdRD1RgzUXL4Yvc06a1mTnXCK-8_E8g/exec' id='STOCK_STOICISM' method='POST' className="space-y-8 text-white bg-none [  ]">
                            <div>
        ...
        <>
            ...
            >
                <div className="flex justify-center items-center pt-[100px]">
                    <h1 className="text-sky-400 font-bold lg:text-5xl text-3xl font-Orbitron">STOCK STOICISM</h1>
                </div>
